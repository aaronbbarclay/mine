...
class material {
public:
    virtual bool scatter(const rray& r_in, const hit_record& rec, vec3& attenuation, rray& scattered) const = 0;
...
public:
    ...
    virtual bool scatter(const rray& r_in, const hit_record& rec, vec3& attenuation, rray& scattered) const {
        vec3 reflected = reflect(unit_vector(r_in.direction()), rec.normal);
        scattered = rray(rec.p, reflected + fuzz*random_in_unit_sphere());
        attenuation = albedo;
